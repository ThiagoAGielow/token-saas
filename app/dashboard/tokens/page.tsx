...
type Pack = { id: string; label?: string; price: number; tokens: number; priceId: string; popular?: boolean };
type Plan = { id: string; key?: string; name: string; price: number; tokens: number; priceId: string };
type Wallet = { balance: number };
type Transaction = { id: string; createdAt: string; description: string; amount: number; balanceAfter: number };
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          {plans.map((plan) => {
            ...
            const features: string[] = PLAN_FEATURES[plan.id] || []
