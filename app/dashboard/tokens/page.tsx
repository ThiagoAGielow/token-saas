...
function TokensContent() {
  ...
  const loadData = useCallback(() => {
    return Promise.all([
      fetch('/api/pricing').then((r) => r.json() as Promise<{ packs?: TokenPack[]; plans?: Plan[] }>),
      fetch('/api/tokens').then((r) => r.json() as Promise<{ wallet?: Wallet; transactions?: TokenTransaction[]; subscription?: Subscription }>),
