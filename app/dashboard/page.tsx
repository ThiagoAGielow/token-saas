...
type DashboardData = {
  tokens?: { wallet?: { balance: number; lifetimeSpent: number }; daysRemaining?: number; transactions?: Transaction[] };
...
export default function DashboardPage() {
  ...
  const breakdown: Record<'websites' | 'domains' | 'emails' | 'ai' | 'other', number> = { websites: 0, domains: 0, emails: 0, ai: 0, other: 0 };
